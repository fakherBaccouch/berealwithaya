...
function Learnwithme() {
    ...
    const divStyle = {
      ...
      const titleStyle= {
        backgroundImage: 'linear-gradient(to right, #C1EA9F, #8FC57B)',
        backgroundClip: 'text',
        color:'transparent'
  ...
  return (
    <div  style={divStyle} className=' flex flex-col items-center justify-around h-screen bg-center bg-cover pt-36 mt-[-8rem]' >
     <h1 style={titleStyle} data-aos="fade-in" className='text-3xl text-center  p-2 font_Kaushan'>What You Learn with Me </h1>
