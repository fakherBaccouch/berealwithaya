...
function Hero() {
  ...
  const divStyle = {
    backgroundImage: `linear-gradient(180deg, #111111 0%, rgba(17, 17, 17, 0.7) 10%), url(${process.env.PUBLIC_URL}/skybg.jpg)`,
  ...
  return (
    <div  style={divStyle}  className="relative custom-clip-path  bg-primaryBlack to-white bg-gradient-to-r   text-left items-left flex flex-col h-auto h-auto bg-cover bg-center overflow-hidden ">
      ...
      <button data-aos="fade-in"  data-aos-delay="300" className='leading-4 z-10		 w-fit px-6 text-lg   bg-primaryPurple   font-bold text-primaryPurple mx-4 mb-4 py-4 rounded-full text-white '>Who is the Real Aya ?</button>

<div className='relative'>
<img alt='hero_img'  data-aos-delay="400" className='w-128 z-10 	opacity-80 mt-[-4rem]' src="./hero2.png" />
</div>
